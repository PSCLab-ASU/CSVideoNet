...
local DataHandler2 = torch.class('DataHandler2')
...
function DataHandler2:__init(args)
  self.train = {}
  self.val = {}
  self.test= {}
...
function DataHandler2:loadData()
...
function DataHandler2:loadTestData()
...
function DataHandler2:getBatch(dataset, index)
  local i = 1
  ...
  for i = 1,self.imgParam.batchSize do
    ...
    if i==1 then
      ...
      data2_2 = rawData2[{{2}, {}, {}, {} }] -- [9, numChannels, 1, mea]
      data2_3 = rawData2[{{3}, {}, {}, {} }] -- [9, numChannels, 1, mea]
      data2_4 = rawData2[{{4}, {}, {}, {} }] -- [9, numChannels, 1, mea]
      data2_5 = rawData2[{{5}, {}, {}, {} }] -- [9, numChannels, 1, mea]
      data2_6 = rawData2[{{6}, {}, {}, {} }] -- [9, numChannels, 1, mea]
      data2_7 = rawData2[{{7}, {}, {}, {} }] -- [9, numChannels, 1, mea]
      data2_8 = rawData2[{{8}, {}, {}, {} }] -- [9, numChannels, 1, mea]
      data2_9 = rawData2[{{9}, {}, {}, {} }] -- [9, numChannels, 1, mea]
      data2_10 = rawData2[{{10}, {}, {}, {} }] -- [9, numChannels, 1, mea]
      ...
      data2_2 = data2_2:cat(rawData2[{{2}, {}, {}, {} }], 1)
      data2_3 = data2_3:cat(rawData2[{{3}, {}, {}, {} }], 1)
      data2_4 = data2_4:cat(rawData2[{{4}, {}, {}, {} }], 1)
      data2_5 = data2_5:cat(rawData2[{{5}, {}, {}, {} }], 1)
      data2_6 = data2_6:cat(rawData2[{{6}, {}, {}, {} }], 1)
      data2_7 = data2_7:cat(rawData2[{{7}, {}, {}, {} }], 1)
      data2_8 = data2_8:cat(rawData2[{{8}, {}, {}, {} }], 1)
      data2_9 = data2_9:cat(rawData2[{{9}, {}, {}, {} }], 1)
      data2_10 = data2_10:cat(rawData2[{{10}, {}, {}, {} }], 1)
  ...
  local data1 = data1_1
  local data2 = data2_1:cat(data2_2, 2)
  local data3 = data2_1:cat(data2_3, 2)
  local data4 = data2_1:cat(data2_4, 2)
  local data5 = data2_1:cat(data2_5, 2)
  local data6 = data2_1:cat(data2_6, 2)
  local data7 = data2_1:cat(data2_7, 2)
  local data8 = data2_1:cat(data2_8, 2)
  local data9 = data2_1:cat(data2_9, 2)
  local data10 = data2_1:cat(data2_10, 2)

  return data1, data2, data3, data4, data5, data6, data7, data8, data9, data10, label
end

function DataHandler2:getValData()
  return self.val
end
