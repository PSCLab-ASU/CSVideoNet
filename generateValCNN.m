...
folder = '~/myGitHub/datasets/UCF101/ValData/0.25_196/';
savepath = ['/home/user/kaixu/myGitHub/caffe/examples/videoNet/training/data/ValDataCNN_', num2str(cr), '_10172016.h5'];
