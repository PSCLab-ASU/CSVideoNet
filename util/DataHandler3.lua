...
local DataHandler3 = torch.class('DataHandler3')

trainDataFile = '/home/user/kaixu/myGitHub/VideoReconNet/data/TrainData_5_25_10172016.h5'
valDataFile = '/home/user/kaixu/myGitHub/VideoReconNet/data/ValData_5_25_10172016.h5'
--testDataFile = '/home/user/kaixu/myGitHub/VideoReconNet/recon/Feature_conv5_5_25_recon.h5'
testDataFile = '/home/user/kaixu/myGitHub/VideoReconNet/data/TestData_5_25_10172016.h5'

function DataHandler3:__init(args)
  self.train = {}
  self.val = {}
  self.test= {}
...
function DataHandler3:loadData()
...
function DataHandler3:loadTestData()
...
function DataHandler3:getBatch(dataset, index)
  local i = 1
...
function DataHandler3:getValData()
  return self.val
end
