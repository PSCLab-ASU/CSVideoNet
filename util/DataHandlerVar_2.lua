...
local DataHandlerVar_2 = torch.class('DataHandlerVar_2')

trainDataFile = '/home/user/kaixu/myGitHub/VideoReconNet/data/Feature_conv5_5_25_train_2.h5'
valDataFile = '/home/user/kaixu/myGitHub/VideoReconNet/data/Feature_conv5_5_25_val_2.h5'
--testDataFile = '/home/user/kaixu/myGitHub/VideoReconNet/recon/Feature_conv5_5_25_recon.h5'
testDataFile = '/home/user/kaixu/myGitHub/VideoReconNet/data/feature_conv5_5_25_train_testing.h5'

function DataHandlerVar_2:__init(args)
  self.train = {}
  self.val = {}
  self.test= {}
...
function DataHandlerVar_2:loadData()
...
function DataHandlerVar_2:loadTestData()
...
function DataHandlerVar_2:getBatch(dataset, index)
  local batch = { data = {torch.FloatTensor(self.imgParam.batchSize * 1,
                                       self.imgParam.numChannels, 1, self.imgParam.measurements1):fill(0),
                          torch.FloatTensor(self.imgParam.batchSize * (self.imgParam.seqLength-1),
                                       self.imgParam.numChannels, 1, self.imgParam.measurements2):fill(0)},


                  label = {torch.FloatTensor(self.imgParam.batchSize * 1,
...
function DataHandlerVar_2:getValData()
  return self.val
end
