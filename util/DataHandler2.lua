...
trainDataFile = '/home/user/kaixu/myGitHub/VideoReconNet/data/TrainData_5_10172016.h5'
valDataFile = '/home/user/kaixu/myGitHub/VideoReconNet/data/ValData_5_10172016.h5'
testDataFile = '/home/user/kaixu/myGitHub/VideoReconNet/data/TestData_5_10172016.h5'
...
function DataHandler2:getBatch(dataset, index)
  ...
  for i = 1,self.imgParam.batchSize do
    ...
    if i==1 then
      ...
      data2 = rawData[{{2}, {}, {}, {}}] -- [9, numChannels, 1, mea]
      data3 = rawData[{{3}, {}, {}, {}}] -- [9, numChannels, 1, mea]
      data4 = rawData[{{4}, {}, {}, {}}] -- [9, numChannels, 1, mea]
      data5 = rawData[{{5}, {}, {}, {}}] -- [9, numChannels, 1, mea]
      data6 = rawData[{{6}, {}, {}, {}}] -- [9, numChannels, 1, mea]
      data7 = rawData[{{7}, {}, {}, {}}] -- [9, numChannels, 1, mea]
      data8 = rawData[{{8}, {}, {}, {}}] -- [9, numChannels, 1, mea]
      data9 = rawData[{{9}, {}, {}, {}}] -- [9, numChannels, 1, mea]
      data10 = rawData[{{10}, {}, {}, {}}] -- [9, numChannels, 1, mea]
